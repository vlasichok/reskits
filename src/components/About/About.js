		...
		<div className="container about">
			<div className="row px-3">
				<div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
					<p><span className="title h2">В ситуации, где счет идет на секунды,</span> для спасения жизни человека должны объединиться два фактора: навыки первой помощи и снаряжение для ее оказания.</p>
