				...
				<div className="col-8 bgr-color d-flex align-items-center">
					<div className="details-list w-100">
						{props.items.map((item, i) => {
							return(
							    <div key={i} className="col-12 col-lg-10 mt-2">
						        	<div className="row mt-2">
						            	<div className="icon col-3 col-lg-1 text-right"><Icon name={item.icon} size="2x" /></div>
							        ...
							        <Collapse isOpen={item.expanded}>
							        	<div className="row">
							            	<div className="descr col-9 offset-3 col-lg-7 offset-lg-1"><p>{item.text}</p></div>
							        	</div>
							        </Collapse>
							    </div>
						    )
