...
const Details = (props) => {
	return( 
		<div className="container-fluid details">
			<div className="row">
				<div className="col-md-3 col-lg-4 col-xl-5 bgr-snake d-none d-md-block"></div>
				<div className="col-12 col-md-9 col-lg-8 col-xl-7 bgr-color d-flex align-items-center">
					<div className="details-list w-100">
						{props.items.map((item, i) => {
							return(
							    <div key={i} className="col-12 col-lg-12 mt-2">
