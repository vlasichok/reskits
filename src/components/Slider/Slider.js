						...
						<div className="current-item row mb-3 mb-md-4 mb-xl-5">
							...
							<div className="col-12">
						        <div className="text-center mt-2">
						        	<button onClick={this.props.toggleInfoModal} className="btn btn-light btn-sm m-2 ml-sm-0">Подробности</button>
						        	<button onClick={this.props.togglePartsModal} className="btn btn-light btn-sm m-2">Состав</button>
						        </div>
					        </div>
				        </div>
				     )}
